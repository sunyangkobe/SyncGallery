...
public class TextPanel extends AbstractContentPanel implements OnDrawableEventListener, OnEditorActionListener {
	...
	private int mHighlightEllipse, mHighlightStrokeWidth, mHighlightStrokeColor, mHighlightStrokeColorDown;
	...
	private void onAddNewText() {
		...
		hv.setOutlineStrokeColor( mHighlightStrokeColor );
		hv.setOutlineStrokeColorPressed( mHighlightStrokeColorDown );
	...
	private MoaActionList onApplyCurrent( final DrawableHighlightView hv ) {
		...
		if ( hv != null ) {
			...
			MoaAction action = MoaActionFactory.action( "text" );
			action.setValue( "text", (String) editable.getText() );
			action.setValue( "fillcolor", mColor );
			action.setValue( "strokecolor", mStrokeColor );
	...
	/* (non-Javadoc)
	 * @see com.aviary.android.feather.widget.ImageViewDrawableOverlay.OnDrawableEventListener#onClick(com.aviary.android.feather.widget.DrawableHighlightView)
	 */
	@Override
	...
	public void onActivate() {
		...
		mHighlightStrokeColor = config.getColor( R.color.feather_text_highlight_stroke );
		mHighlightStrokeColorDown = config.getColor( R.color.feather_text_highlight_stroke_down );

		minTextSize = config.getInteger( R.integer.feather_text_minSize );
		defaultTextSize = config.getInteger( R.integer.feather_text_defaultSize );
	...
	/* (non-Javadoc)
	 * @see com.aviary.android.feather.widget.ImageViewDrawableOverlay.OnDrawableEventListener#onDown(com.aviary.android.feather.widget.DrawableHighlightView)
	 */
	@Override
	public void onDown( final DrawableHighlightView view ) {}

	/* (non-Javadoc)
	 * @see com.aviary.android.feather.widget.ImageViewDrawableOverlay.OnDrawableEventListener#onFocusChange(com.aviary.android.feather.widget.DrawableHighlightView, com.aviary.android.feather.widget.DrawableHighlightView)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.aviary.android.feather.widget.ImageViewDrawableOverlay.OnDrawableEventListener#onMove(com.aviary.android.feather.widget.DrawableHighlightView)
	 */
	@Override
