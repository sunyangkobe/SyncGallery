...
public class DrawingPanel extends AbstractContentPanel implements OnDrawStartListener, OnDrawPathListener {
	...
	public void onCreate( Bitmap bitmap ) {
		...
		mBrushSizes = mConfig.getIntArray( R.array.feather_brush_sizes );
	...
	private void resetBitmap() {
		mImageView.setImageBitmap( mBitmap, true, getContext().getCurrentImageViewMatrix(), Constants.IMAGE_VIEW_MAX_ZOOM );
