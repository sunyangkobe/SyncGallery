...
public class EffectLoaderService extends EffectContextService {
	...
	public AbstractEffectPanel load( EffectEntry entry ) {
		...
		switch ( entry.name ) {
			...
			case BRIGHTNESS:
				panel = new ColorMatrixEffectPanel( context, Filters.BRIGHTNESS, "brightness" );
				break;
			...
			case CONTRAST:
				panel = new ColorMatrixEffectPanel( context, Filters.CONTRAST, "contrast" );
				break;

			case SHARPNESS:
				panel = new NativeEffectRangePanel( context, Filters.SHARPNESS, "sharpness" );
				break;
			...
			case RED_EYE:
				panel = new SpotDrawPanel( context, Filters.RED_EYE );
				break;

			case WHITEN:
				panel = new SpotDrawPanel( context, Filters.WHITEN );
				break;

			case BLEMISH:
				panel = new SpotDrawPanel( context, Filters.BLEMISH );
				break;
