...
public class ImageViewSpotDraw extends ImageViewTouch {
 ...
 DRAW
	...
	/**
	 * The listener interface for receiving onDraw events.
	 * The class that is interested in processing a onDraw
	 * event implements this interface, and the object created
	 * with that class is registered with a component using the
	 * component's <code>addOnDrawListener<code> method. When
	 ...
	 *
	 * @param listener the new on draw start listener
	 */
	 ...
	 * Sets the brush size.
	 *
	 * @param value the new brush size
	 */
